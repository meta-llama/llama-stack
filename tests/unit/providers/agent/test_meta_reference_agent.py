...
async def agents_impl(config, mock_apis):
    impl = MetaReferenceAgentsImpl(
        config=config,
        inference_api=mock_apis["inference_api"],
        vector_io_api=mock_apis["vector_io_api"],
        safety_api=mock_apis["safety_api"],
        tool_runtime_api=mock_apis["tool_runtime_api"],
        tool_groups_api=mock_apis["tool_groups_api"],
    )
