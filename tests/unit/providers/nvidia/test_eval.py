...
@pytest.mark.asyncio
async def test_register_benchmark(nvidia_eval_setup, run_async):
    ...
    await run_async(eval_impl.register_benchmark(benchmark))
...
@pytest.mark.asyncio
async def test_run_eval(nvidia_eval_setup, run_async):
    eval_impl = nvidia_eval_setup["eval_impl"]
    mock_evaluator_post = nvidia_eval_setup["mock_evaluator_post"]
    ...
    result = await run_async(eval_impl.run_eval(benchmark_id=MOCK_BENCHMARK_ID, benchmark_config=benchmark_config))
...
@pytest.mark.asyncio
async def test_job_status(nvidia_eval_setup, run_async):
    eval_impl = nvidia_eval_setup["eval_impl"]
    ...
    result = await run_async(eval_impl.job_status(benchmark_id=MOCK_BENCHMARK_ID, job_id="job-123"))
...
@pytest.mark.asyncio
async def test_job_cancel(nvidia_eval_setup, run_async):
    eval_impl = nvidia_eval_setup["eval_impl"]
    mock_evaluator_post = nvidia_eval_setup["mock_evaluator_post"]
    ...
    await run_async(eval_impl.job_cancel(benchmark_id=MOCK_BENCHMARK_ID, job_id="job-123"))
...
@pytest.mark.asyncio
async def test_job_result(nvidia_eval_setup, run_async):
    eval_impl = nvidia_eval_setup["eval_impl"]
    mock_evaluator_get = nvidia_eval_setup["mock_evaluator_get"]
    ...
    result = await run_async(eval_impl.job_result(benchmark_id=MOCK_BENCHMARK_ID, job_id="job-123"))
