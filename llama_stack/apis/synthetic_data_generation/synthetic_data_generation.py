...
# TODO: consider shortening the route
class SyntheticDataGeneration(Protocol):
    ...
    # TODO: should these be under /generate/?
    ...
    async def update_synthetic_data_generation_job(self) -> SyntheticDataGenerationJob: ...
    ...
    @webmethod(route="/synthetic-data-generation/jobs/{job_id:path}/logs", method="GET")
    async def get_synthetic_data_generation_job_logs(self) -> str: ...
