...
class PostTraining(Protocol):
    ...
    @webmethod(route="/post-training/jobs/{job_id}", method="GET")
    async def get_training_job(self, job_id: str) -> Optional[PostTrainingJob]: ...

    @webmethod(route="/post-training/jobs/{job_id}", method="DELETE")
