...
class PostTraining(Protocol):
    ...
    # TODO: update type hints for all arguments
    # TODO: can we auto-generate these for all action endpoints?
    ...
    # TODO: define proper interface for update
