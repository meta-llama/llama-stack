...
class Telemetry(Protocol):
    ...
    @webmethod(route="/telemetry/traces", method="POST", access_control=READ_ACCESS_POLICY)
    ...
    @webmethod(route="/telemetry/traces/{trace_id:path}", method="GET", access_control=READ_ACCESS_POLICY)
    ...
    @webmethod(
        route="/telemetry/traces/{trace_id:path}/spans/{span_id:path}", method="GET", access_control=READ_ACCESS_POLICY
    )
    ...
    @webmethod(route="/telemetry/spans/{span_id:path}/tree", method="POST", access_control=READ_ACCESS_POLICY)
    ...
    @webmethod(route="/telemetry/spans", method="POST", access_control=READ_ACCESS_POLICY)
    ...
    @webmethod(route="/telemetry/metrics/{metric_name}", method="POST", access_control=READ_ACCESS_POLICY)
