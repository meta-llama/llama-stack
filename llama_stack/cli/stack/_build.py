...
def run_stack_build_command(args: argparse.Namespace) -> None:
    ...
    if args.template:
        ...
        if build_config.image_type == LlamaStackImageType.container and not args.image_name:
            cprint(
...
def _generate_run_config(
    ...
    run_config = StackRunConfig(
        container_image=(image_name if build_config.image_type == LlamaStackImageType.container else None),
        image_name=image_name,
        apis=apis,
        providers={},
    )
