...
from llama_stack.apis.common.errors import UnsupportedDatabaseError
...
class AuthorizedSqlStore:
    ...
    def __init__(self, sql_store: SqlStore):
        ...
        self.supported_databases: list[SqlStoreType] = list(SqlStoreType)
    ...
    def _detect_database_type(self) -> None:
        ...
        if self.database_type not in self.supported_databases:
            raise UnsupportedDatabaseError(self.database_type, [db.value for db in self.supported_databases])
