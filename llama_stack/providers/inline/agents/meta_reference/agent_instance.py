...
class ChatAgent(ShieldRunnerMixin):
    ...
    async def execute_tool_call_maybe(
        ...
        logcat.info("agents", f"executing tool call: {tool_name_str} with args: {tool_call.arguments}")
        ...
        logcat.debug("agents", f"tool call {tool_name_str} completed with result: {result}")
        return result
